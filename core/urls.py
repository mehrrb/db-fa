...
urlpatterns = [
    ...
    path('legacy/product-types/', ProductTypeListView.as_view(), name='product_type_list'),
    path('legacy/get-product-type-unit/', views.get_product_type_unit, name='get_product_type_unit'),
    ...
    path('legacy/recipes/<int:recipe_id>/edit/', views.recipe_update, name='recipe_update'),
    path('legacy/recipes/<int:recipe_id>/delete/', views.recipe_delete, name='recipe_delete'),
    
    # Recipe item management legacy URLs
    path('legacy/recipe-items/<int:item_id>/delete/', views.recipe_item_delete, name='recipe_item_delete'),
] 